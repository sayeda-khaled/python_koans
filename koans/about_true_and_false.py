...
class AboutTrueAndFalse(Koan):
    ...
    #according to the above class, when condition is true, return 'true stuff'
    def test_true_is_treated_as_true(self):
    ...
    #     self.assertEqual(__, self.truth_value(False))
        #according to the above class, when condition is false, return 'false stuff'
    ...
    #if the truthy condition is not met, the return will be the falsy
