...
class AboutMethods(Koan):
    ...
    # The use of self variable in Python helps to differentiate between the instance attributes (and methods) and
    # local variables.
    ...
    # The difference between a comment and a pass statement in Python is tha
    ...
    # single line method, do ot require indentation
    ...
    # with Python modules, functions, classes, and methods. It’s specified in source code that is used, like a comment,
